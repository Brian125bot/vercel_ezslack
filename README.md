...
| v6.2.2 | ✅ Done | Production Reliability & Feedback Fixes (interactivity sig verify, model selection in slack.ts, step-level approval resume, confidence normalization, semaphore timeout, observability) |
v5.5 Native multimodal and turn fixes
