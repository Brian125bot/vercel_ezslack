...
export async function createPlan(
  ...
  // Build the tool catalogue dynamically from the registry, scoped to
  // whatever tool policy applies to this workspace/channel (unrestricted by
  // default — see resolveAllowedTools).
